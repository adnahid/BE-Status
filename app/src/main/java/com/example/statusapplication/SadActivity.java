...
public class SadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // EdgeToEdge.enable(this);
        ...
        sadImageBack = findViewById(R.id.sadImageBack);
        ...
        sadImageBack.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private class RAdapter extends RecyclerView.Adapter{
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            ...
            if (getItemViewType(position)==Read){
                ...
                AdLoader adLoader = new AdLoader.Builder(SadActivity.this, "ca-app-pub-3940256099942544/2247696110")
