...
public class LifeOriented extends AppCompatActivity {
    ...
    private class LifeOrientedAdapter extends RecyclerView.Adapter{
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            ...
            if (getItemViewType(position)==Read){
                ...
                readHolder.tvTitle.setText(texTitle);
                readHolder.tvDes.setText(texDes);
                ...
                readHolder.ItemCard.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        DetailsActivity.StatusText = texDes;
                        DetailsActivity.StatusTitle = texTitle;


                        Bitmap bitmap = ((BitmapDrawable) readHolder.itemImage.getDrawable()).getBitmap();
                        DetailsActivity.StatusBitmap = bitmap;
                        Intent intent = new Intent(LifeOriented.this,DetailsActivity.class);
                        startActivity(intent);
    ...
    private void lifeOrientedTable(){
        ...
        hashMap.put("image","https://www.banglakobitablog.com/ezoimgfmt/1.bp.blogspot.com/-A5wQAIODPMc/YCNt8y-KICI/AAAAAAAABRg/VPvrfZSJ1agqt7QyARSJwtDLfub_SXkjQCLcBGAsYHQ/w320-h320/jibon-niye-ukti.jpg?");
        hashMap.put("cat","ক্যাপশন");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/s2dDc1G3/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post.png");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://th.bing.com/th/id/OIP.ZaujO_0HOcnvC3YVZbfjuwHaG7?rs=1&pid=ImgDetMain");
        hashMap.put("cat","উক্তি ও বাণী");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/13w26Kx5/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-1.png");
        hashMap.put("cat","ক্যাপশন");
...
//
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://th.bing.com/th/id/OIP.ViS4C6Yrrh5eWFajfm-wcQHaEK?rs=1&pid=ImgDetMain");
        hashMap.put("cat","স্ট্যাটাস");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/63gFnbQq/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-3.png");
        hashMap.put("cat","উক্তি ও বাণী");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/mDz5L3Ss/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-4.png");
        hashMap.put("cat","ক্যাপশন");
...
//
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/kXL6Pg2p/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post.png");
        hashMap.put("cat","স্ট্যাটাস");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/fytz8YfT/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-1.png");
        hashMap.put("cat","উক্তি ও বাণী");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/x1ys4C5K/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-2.png");
        hashMap.put("cat","স্ট্যাটাস");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/9X6JXTNd/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-3.png");
        hashMap.put("cat","উক্তি ও বাণী");
...
//
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/L8NtPZv0/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-4.png");
        hashMap.put("cat","উক্তি ও বাণী");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/jdhPV7Vd/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-5.png");
        hashMap.put("cat","ক্যাপশন");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/1R71vWX9/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-6.png");
        hashMap.put("cat","উক্তি ও বাণী");
...
//
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/CLwJfYS5/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-7.png");
        hashMap.put("cat","উক্তি ও বাণী");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/yYr9YzNw/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-8.png");
        hashMap.put("cat","উক্তি ও বাণী");
...
//
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/LhdpNXTc/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-9.png");
        hashMap.put("cat","ক্যাপশন");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/63sgkSRZ/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-10.png");
        hashMap.put("cat","ক্যাপশন");
...
//
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/vZJ0TnBF/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-11.png");
        hashMap.put("cat","উক্তি ও বাণী");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/15q9tMk5/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-12.png");
        hashMap.put("cat","ক্যাপশন");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://img.freepik.com/free-vector/cartoon-landscape_2614-42.jpg?size=338&ext=jpg");
        hashMap.put("cat","স্ট্যাটাস");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://www.banglakobitablog.com/ezoimgfmt/1.bp.blogspot.com/-zKoQmXkAVEM/YCN0yeeJCGI/AAAAAAAABSE/9sIFDTTv6IAPykSKWzJpqONYC6qUd1W9wCLcBGAsYHQ/w320-h320/jibon-niye-ukti-4.jpg?\n");
        hashMap.put("cat","উক্তি ও বাণী");
...
//
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/rsFztWLF/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-13.png");
        hashMap.put("cat","স্ট্যাটাস");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/nr3PPzM1/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-14.png");
        hashMap.put("cat","উক্তি ও বাণী");
...
//
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/7Z1wK1w1/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-15.png");
        hashMap.put("cat","ক্যাপশন");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/FspQcrZG/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-16.png");
        hashMap.put("cat","স্ট্যাটাস");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/g0GTyQzp/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-17.png");
        hashMap.put("cat","স্ট্যাটাস");
...
//
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/76ZPRKV8/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-18.png");
        hashMap.put("cat","স্ট্যাটাস");
        hashMap.put("texTitle","— সংগৃহীত");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/mgSt61s9/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-19.png");
        hashMap.put("cat","ক্যাপশন");
        hashMap.put("texTitle","— সংগৃহীত");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/hP25cpcP/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-20.png");
        hashMap.put("cat","স্ট্যাটাস");
        hashMap.put("texTitle","— সংগৃহীত");
...
//
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://www.banglakobitablog.com/wp-content/uploads/2022/09/jibon-niye-ukti-caption-pic-banglakobitablog-1.jpg");
        hashMap.put("cat","স্ট্যাটাস");
        hashMap.put("texTitle","— সংগৃহীত");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/SKygYPqM/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-21.png");
        hashMap.put("cat","ক্যাপশন");
        hashMap.put("texTitle","— সংগৃহীত");
...
//
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/X79JpHs3/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-22.png");
        hashMap.put("cat","উক্তি ও বাণী");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/SKdz1y5g/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-23.png");
        hashMap.put("cat","ক্যাপশন");
        hashMap.put("texTitle","– স্টিফেন হকিং");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/Bb0cPq8s/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-24.png");
        hashMap.put("cat","উক্তি ও বাণী");
...
//
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/JzyZpDCK/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-25.png");
        hashMap.put("cat","উক্তি ও বাণী");
        hashMap.put("texTitle","– স্টিফেন হকিং");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/23NyT6Q9/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-26.png");
        hashMap.put("cat","ক্যাপশন");
        hashMap.put("texTitle","– চার্লি চ্যাপলিন");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/k5gFPnZh/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-27.png");
        hashMap.put("cat","উক্তি ও বাণী");
...
//
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/15y8jvbv/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-28.png");
        hashMap.put("cat","ক্যাপশন");
        hashMap.put("texTitle","— সংগৃহীত");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/jSNBnhSr/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-29.png");
        hashMap.put("cat","স্ট্যাটাস");
        hashMap.put("texTitle","— সংগৃহীত");
...
//
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/J0G2rN2v/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-30.png");
        hashMap.put("cat","ক্যাপশন");
        hashMap.put("texTitle","— সংগৃহীত");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/FKNCd56j/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-31.png");
        hashMap.put("cat","ক্যাপশন");
...
//
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/wx1zTLL9/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-32.png");
        hashMap.put("cat","স্ট্যাটাস");
        hashMap.put("texTitle","— সংগৃহীত");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/HxM54jRR/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-33.png");
        hashMap.put("cat","ক্যাপশন");
...
//
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/mrgKD1hY/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-34.png");
        hashMap.put("cat","স্ট্যাটাস");
