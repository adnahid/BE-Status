...
public class Islamic extends AppCompatActivity {
            ...
            if (getItemViewType(position)==Read){
                ...
                readHolder.ItemCard.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(Islamic.this,DetailsActivity.class);
                        startActivity(intent);
    ...
    private void islamicTable(){
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.pinimg.com/originals/29/0f/1b/290f1bd21caf451f479d1d5748abb536.jpg");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.pinimg.com/736x/2f/cb/80/2fcb80c870189aea42860cd966f79a30.jpg");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.pinimg.com/736x/b4/bd/7b/b4bd7b48e037c55c71975fddb95d26a0.jpg");
        hashMap.put("cat","স্ট্যাটাস");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.pinimg.com/originals/f5/a6/96/f5a696841c554f2272e5cf394a5054a9.jpg");
        hashMap.put("cat","ক্যাপশন");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.pinimg.com/736x/73/7e/90/737e902f5426ff4df5f8d8de13c5a20f.jpg\n");
        hashMap.put("cat","বাণী ও উক্তি");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://th.bing.com/th/id/OIP.orNkkSynJNQstl4UK1hTCAHaHo?rs=1&pid=ImgDetMain");
        hashMap.put("cat","স্ট্যাটাস");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.pinimg.com/736x/c2/b4/26/c2b426646487dd3337d784f453f1b06f.jpg");
        hashMap.put("cat","ক্যাপশন");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/3R1t9FDB/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post.png");
        hashMap.put("cat","বাণী ও উক্তি");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/zDMCNQ5h/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-1.png");
        hashMap.put("cat","স্ট্যাটাস");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.pinimg.com/originals/d5/ac/0a/d5ac0a5c97b318e70dc4416a8e0ccdae.jpg");
        hashMap.put("cat","ক্যাপশন");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/g0YMngdN/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-21.png");
        hashMap.put("cat","বাণী ও উক্তি");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.pinimg.com/736x/59/46/77/59467738ac6ad0889c157a40f1b6362f.jpg");
        hashMap.put("cat","স্ট্যাটাস");
        hashMap.put("texTitle","— (আল হাদিস) ");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.pinimg.com/originals/ea/15/12/ea1512c0a17b4e4149b0a4833abd1ff4.jpg");
        hashMap.put("cat","বাণী ও উক্তি");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/m22dXqmP/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-2.png  ");
        hashMap.put("cat","স্ট্যাটাস");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/VkFxGrkZ/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-22.png");
        hashMap.put("cat","ক্যাপশন");
        hashMap.put("texTitle","— (বুখারী) ");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/65LT5vpD/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-3.png");
        hashMap.put("cat","বাণী ও উক্তি");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/TPbzfrRb/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-4.png");
        hashMap.put("cat","ক্যাপশন");
        hashMap.put("texTitle","— (বুখারী)");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/Sxw6z64J/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-5.png");
        hashMap.put("cat","স্ট্যাটাস");
        hashMap.put("texTitle","— (বুখারী)");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/wTPgKVLf/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-6.png");
        hashMap.put("cat","স্ট্যাটাস");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/L8ZqjS4s/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-23.png");
        hashMap.put("cat","ক্যাপশন");
        hashMap.put("texTitle","— সহীহ মুসলিম");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/g2BCb933/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-24.png");
        hashMap.put("cat","বাণী ও উক্তি");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/Z58QQJjP/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-7.png");
        hashMap.put("cat","ক্যাপশন");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/Y96frSG8/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-8.png");
        hashMap.put("cat","স্ট্যাটাস");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/7Zg2p4FW/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-25.png");
        hashMap.put("cat","বাণী ও উক্তি");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.pinimg.com/originals/cd/f4/0f/cdf40f66ed94ed1aa7de533d8d63e349.jpg");
        hashMap.put("cat","স্ট্যাটাস");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/NFMS5Bqs/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-26.png");
        hashMap.put("cat","স্ট্যাটাস");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://th.bing.com/th?id=OIP.TrnoCbZvs1rnKHAQJNTxRgHaHa&w=250&h=250&c=8&rs=1&qlt=90&o=6&dpr=2&pid=3.1&rm=2");
        hashMap.put("cat","স্ট্যাটাস");
        hashMap.put("texTitle","—  মুসলিম");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/fyx97qjK/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-9.png");
        hashMap.put("cat","স্ট্যাটাস");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/TPqFST2M/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-10.png");
        hashMap.put("cat","বাণী ও উক্তি");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/R0SjjcsJ/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-27.png\n");
        hashMap.put("cat","স্ট্যাটাস");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/wTgCXy95/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-12.png");
        hashMap.put("cat","স্ট্যাটাস");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://th.bing.com/th/id/OIP.if2s_7ZFSPEO9niZ7AyDPgAAAA?w=215&h=215&c=7&r=0&o=5&dpr=2&pid=1.7");
        hashMap.put("cat","স্ট্যাটাস");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/t4wxc5C2/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-28.png");
        hashMap.put("cat","ক্যাপশন");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://th.bing.com/th/id/OIP.dFOCauMG7-LNk5-9TLoVjAHaHa?w=185&h=185&c=7&r=0&o=5&dpr=2&pid=1.7");
        hashMap.put("cat","স্ট্যাটাস");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://th.bing.com/th/id/OIP.sGeKtFLRGglxWoesWXrN2AHaH3?pid=ImgDet&w=192&h=203&c=7&dpr=2");
        hashMap.put("cat","বাণী ও উক্তি");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.pinimg.com/originals/4f/dc/62/4fdc626d09ba85e1e290ccc51426483b.jpg");
        hashMap.put("cat","ক্যাপশন");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://th.bing.com/th/id/OIP.if2s_7ZFSPEO9niZ7AyDPgAAAA?rs=1&pid=ImgDetMain");
        hashMap.put("cat","বাণী ও উক্তি");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://4.bp.blogspot.com/-l1qDDRcHDC4/WFALR3NQJEI/AAAAAAAAG8k/dsRmwrPtnSsoS2LkSf2fXqQ3GMpgBlV1QCLcB/s1600/10492402_1519583084962979_6637847274029330747_n.jpg");
        hashMap.put("cat","বাণী ও উক্তি");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/TYfwPQ4t/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-13.png");
        hashMap.put("cat","ক্যাপশন");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/8ctVcd7Y/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-14.png");
        hashMap.put("cat","বাণী ও উক্তি");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/P5fQ1WP4/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-15.png");
        hashMap.put("cat","বাণী ও উক্তি");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/kG1XzPvD/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-16.png");
        hashMap.put("cat","ক্যাপশন");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://live.staticflickr.com/65535/49048654261_c6e75daac8_b.jpg");
        hashMap.put("cat","স্ট্যাটাস");
        ...
        hashMap = new HashMap<>();
        hashMap.put("itemType","read");
        hashMap.put("image","https://i.postimg.cc/XNTn5cJr/Yellow-White-Minimalist-Quote-Reminder-Facebook-Post-17.png");
        hashMap.put("cat","স্ট্যাটাস");
